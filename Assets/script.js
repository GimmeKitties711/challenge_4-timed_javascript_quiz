var questions = [
    ...
    {
        id: 1,
        question: "Which line of code adds the attribute 'display: none' to a div?",
    ...
    {
        id: 2,
        question: "Which of the following methods joins all elements of an array into a string?",
    ...
    {
        id: 5,
        question: "Write the following phrase as an if condition: 'if color is not red...'",
        a: "if (color NOT== 'red')",
        b: "if (color ! 'red')",
        c: "if (color == !('red'))",
        d: "if (color !== 'red')",
    ...
    {
        id: 6,
        question: "Which line of code adds an event listener that triggers when an element is clicked?",
    ...
    {
        id: 7,
        question: "Which line of code selects a div with an id of 'password'?",
    ...
    {
        id: 8,
        question: "Which of the following choices demonstrates the correct syntax for writing a function?",
        a: "function(params) ( )",
        b: "function(params) [ ]",
        c: "function(params) { }",
        d: "function[params] ( )",
    ...
    {
        id: 9,
        question: "In an object with multiple keys, the keys need to be separated by...",
        a: "semicolons (;)",
        b: "dashes (-)",
        c: "periods (.)",
        d: "commas (,)",
